            ...
            <div class="card-body">
                <table class="table aiz-table mb-0">
                    ...
                    <tbody>
                        ...
                        <?php $order = App\Models\Order::with('user')->where('id','=',$measurment->order_id)->first();
                              $product = App\Models\Product::where('id','=',$measurment->product_id)->first(); ?>
                            <tr>
                                @if (auth()->user()->can('delete_order'))
                                    <td>
                                        <div class="form-group">
                                ...
                                @else
                                    <td>{{ $key + 1 + ($measurments->currentPage() - 1) * $measurments->perPage() }}</td>
                                @endif
                                <td>
                                    {{ $order->code }}
                                </td>
                ...
                <div class="aiz-pagination">
                    {{ $measurments->appends(request()->input())->links() }}
                </div>
