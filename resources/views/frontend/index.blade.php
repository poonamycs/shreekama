...
<link rel='stylesheet' href='https://cdn.rawgit.com/sachinchoolur/lightgallery.js/master/dist/css/lightgallery.css'>
    ...
    <div class="container-fluid bg-primary py-4">
        <marquee direction="left" height="auto" loop="infinite">
            <h2 class="mb-0 stroke-text italictitle marqueefont">From Casual to Couture: Find Your Signature Look Here <span class="mx-5">From Casual to Couture: Find Your Signature Look Here</span><span class="mx-5">From Casual to Couture: Find Your Signature Look Here</span></h2>
        </marquee>
    </div> 
...
<div class="container-fluid card bg-white">
    <div class="row text-center justify-content-center">
        <div class="col-md-3 p-2 row">
            <div class="col-md-3">
                <img src="{{asset('assets/img/icon6.png')}}" class="w-70px disthome mb-2">  
            </div>
            <div class="col-md-9">
                <h6 class="fw-600 text-black mt-3 text-left">Shop the world's largest products market place</h6>
            </div>
        </div>
        <div class="col-md-3 p-2 row">
            <div class="col-md-3">
                <img src="{{asset('assets/img/icon7.png')}}" class="w-70px disthome mb-2">  
            </div>
            <div class="col-md-9">
                <h6 class="fw-600 text-black mt-3 text-left ml-2">Our support team is always here to help</h6>
            </div>
        </div>
        <div class="col-md-3 p-2 row">
            <div class="col-md-3">
                <img src="{{asset('assets/img/icon5.png')}}" class="w-70px disthome mb-2">  
            </div>
            <div class="col-md-9">
                <h6 class="fw-600 text-black mt-3 text-left  ml-2">Careful delivery right to your doorstep</h6>
            </div>
        </div>
        <div class="col-md-3 p-2 row">
            <div class="col-md-3">
                <img src="{{asset('assets/img/icon4.png')}}" class="w-70px disthome mb-2">  
            </div>
            <div class="col-md-9">
                <h6 class="fw-600 text-black mt-3 text-left">Check the honest reviews of produts before purchase</h6>
            </div>
        </div> 
    </div>
</div>
    ...
    @if (get_setting('vendor_system_activation') == 1)
        ...
        @endphp
        <section class="mb-2 mb-md-3 mt-2 mt-md-3 d-none">
            <div class="container">
                <!-- Top Section -->
                <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                    <!-- Title -->
    ...
    @if (get_setting('top_brands') != null)
        <section class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="container">
                ...
                <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                    <!-- Title -->
                    <h3 class=" mb-2 mb-sm-0 cursivefont fs-28 font-weight-light">{{ translate('Top Brands') }}</h3>
                    <!-- Links -->
                    <div class="d-flex">
                        <a class="text-primary fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary" href="{{ route('brands.all') }}">{{ translate('View All Brands') }}</a>
                    </div>
                </div>
                <!-- Brands Section -->
                            ...
                            @if ($brand != null)
                                <div class="col text-center border-right border-bottom hov-scale-img has-transition hov-shadow-out z-1">
                                    <a href="{{ route('products.brand', $brand->slug) }}" class="d-block p-sm-3">
                                        <img src="{{ uploaded_asset($brand->logo) }}" class="lazyload h-md-100px mx-auto has-transition  mw-100"
