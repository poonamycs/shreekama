...
@section('content')
    <section class="gry-bg py-6" style="background-image:url('{{asset('assets/img/loginbg.png')}}');background-size: contain;background-repeat: no-repeat;">
        <div class="profile">
            <div class="container">
                <div class="row">
                    <div class="col-xl-8 col-lg-10 mx-auto">
                        <div class=" shadow-none rounded-0 ">
                            <div class="row justify-content-end">
                                <!-- Left Side -->
                                <div class="col-lg-6 col-md-7 p-4 p-lg-5 border card">
                                    <!-- Titles -->
                                    ...
                                    <div class="pt-3 pt-lg-4">
                                        <div class="">
                                            <form class="form-default" role="form" action="{{ url('user_login') }}" method="POST">
                                                @csrf
                                                ...
                                                @else
                                                    <div class="form-group">
                                                        <label for="mobile" class="fs-12 fw-700 text-soft-dark">{{  translate('Mobile') }}</label>
                                ...
                                <!-- Right Side Image -->
                               {{--  <div class="col-lg-6 col-md-5 py-3 py-md-0 d-none">
