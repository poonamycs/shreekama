    ...
    <!-- Top Bar -->
    <div class="top-navbar z-1035 h-35px h-sm-auto bg-soft-info">
                ...
                <div class="col-lg-6 col">
                    <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                        ...
                        @if (get_setting('show_language_switcher') == 'on')
                            <li class="list-inline-item dropdown mr-4 d-none" id="lang-change">
                                @php
                ...
                <div class="col-6 text-right d-none d-lg-block">
                    <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                        @if (get_setting('vendor_system_activation') == 1)
                            <!-- Become a Seller -->
                            <li class="list-inline-item mr-0 pl-0 py-2 d-none">
                        ...
                        @if (get_setting('contact_email'))
                            ...
                            <li class="list-inline-item ml-3 pl-3 mr-0 pr-0">
                                <a href="tel:{{ get_setting('helpline_number') }}"
                                    ...
                                    <span><i class="la la-envelope fs-16"></i></span>
                        ...
                        @if (get_setting('helpline_number'))
                            ...
                            <li class="list-inline-item ml-3 pl-3 mr-0 pr-0">
                                <a href="tel:{{ get_setting('helpline_number') }}"
                                    class="text-secondary fs-12 d-inline-block py-2">
                                    <span><i class="la la-phone fs-16"></i></span>
                    ...
                    <button type="button" class="btn d-lg-none mr-3 mr-sm-4 p-0 active" data-toggle="class-toggle"
                        ...
                        <svg id="Component_43_1" data-name="Component 43 – 1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <rect id="Rectangle_19062" data-name="Rectangle 19062" width="16" height="2"
                                transform="translate(0 7)" fill="#0a9181" />
                            <rect id="Rectangle_19063" data-name="Rectangle 19063" width="16" height="2"
                                fill="#919199" />
                            <rect id="Rectangle_19064" data-name="Rectangle 19064" width="16" height="2"
                                transform="translate(0 14)" fill="#0a9181" />
                        </svg>
                                    ...
                                    <div class="search-input-box">
                                        ...
                                        <svg id="Group_723" data-name="Group 723" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <path id="Path_3090" data-name="Path 3090"
                                                ...
                                                transform="translate(-1.854 -1.854)" fill="#0a9181" />
                                            <path id="Path_3091" data-name="Path 3091"
                                                d="M24.4,25.2a.8.8,0,0,1-.565-.234l-6.15-6.15a.8.8,0,0,1,1.13-1.13l6.15,6.15A.8.8,0,0,1,24.4,25.2Z"
                                                transform="translate(-5.2 -5.2)" fill="#0a9181" />
                                        </svg>
                                    </div>
                                </div>
                            </form>
                                        ...
                                        <span class="position-relative d-inline-block">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14.668" height="16"
                                                ...
                                                <path id="_26._Notification" data-name="26. Notification"
                                                    ...
                                                    transform="translate(-0.999)" fill="#0a9181" />
                                            </svg>
                                ...
                                <span
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="19.902" height="20.012"
                                        ...
                                        <path id="fe2df171891038b33e9624c27e96e367"
                                            ...
                                            transform="translate(-2.064 -1.995)" fill="#0a9181" />
                                    </svg>
                                </span>
