        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="mb-4 text-secondary text-justify footertext">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            ...
                            <p  class="fs-13 text-soft-light">
                               <a href="https://www.google.com/maps/place/44E,+Tagore+Nagar+E-Block,+Tagore+Nagar,+Ludhiana,+Punjab+141001/@30.9152408,75.8191597,17z/data=!3m1!4b1!4m6!3m5!1s0x391a83e92befe3d9:0x86f9b198f2411b60!8m2!3d30.9152362!4d75.8217346!16s%2Fg%2F11c5kjxxg3?entry=ttu" class="fs-13 text-soft-light hov-text-primary" target="_blank">
                                    
                                {{ get_setting('contact_address',null,App::getLocale()) }}</a></p>
                        </li>
                        <li class="mb-2">
                            <p  class="fs-13 text-secondary mb-1">{{ translate('Phone') }}</p>
                            <p  class="fs-13 text-soft-light">
                                <a href="tel:{{ get_setting('contact_phone') }}" class="fs-13 text-soft-light hov-text-primary">{{ get_setting('contact_phone')  }}</a></p>
                        </li>
                        <li class="mb-2">
