...
<div class="aiz-card-box h-auto bg-white py-3 hov-scale-img">
    <div class="position-relative h-350px h-md-497px img-fit overflow-hidden">
        @php
        ...
        <div class="aiz-carousel product-gallery arrow-inactive-transparent arrow-lg-none"
            data-nav-for='.product-gallery-thumb' data-fade='true' data-arrows="true" data-autoplay="true" data-nav="true">
            @if ($product->digital == 0)
                @foreach ($product->stocks as $key => $stock)
                    @if ($stock->image != null)
                    <a href="{{ $product_url }}" class="d-block h-100 ">
                        <div class="carousel-box img-zoom rounded-0 p-0">
    ...
    <div class="col-12 mt-3 d-none">
        <div class="aiz-carousel product-gallery-thumb" data-items='7' data-nav-for='.product-gallery'
            data-focus-select='true' data-arrows='true' data-vertical='false'  data-autoplay="true" >
