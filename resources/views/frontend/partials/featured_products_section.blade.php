@if (count(get_featured_products()) > 0)
    <section class="mb-2 mb-md-3 mt-2 mt-md-3"  style="background-image:url('{{asset('assets/img/clothsbg.png')}}');background-size: cover;background-repeat: no-repeat;background-position: bottom;">
        <div class="container">
            <!-- Top Section -->
            <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                <!-- Title -->
                <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                    <span class="cursivefont fs-28 font-weight-light">{{ translate('Featured Products') }}</span>
                </h3>
                <!-- Links -->
                <div class="d-flex">
            ...
            <!-- Products Section -->
            <div class="px-sm-3">
                <div class="aiz-carousel sm-gutters-16 arrow-none" data-items="4" data-xl-items="4" data-lg-items="4"  data-md-items="4" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
