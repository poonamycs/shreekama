        ...
        <div class="container">
            ...
            <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                ...
                <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                    <span class="cursivefont fs-28 font-weight-light">{{ translate('New Products') }}</span>
                </h3>
                <!-- Links -->
                <div class="d-flex">
                    ...
                    <a class="text-primary fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary" href="{{ route('search',['sort_by'=>'newest']) }}">{{ translate('View All') }}</a>
