@if (get_setting('best_selling') == 1 && count(get_best_selling_products(20)) > 0)
    <section class="mb-2 mb-md-3 mt-2 mt-md-3" style="background-image:url('{{asset('assets/img/clothsbg1.png')}}');background-size: cover;background-repeat: no-repeat;background-position: bottom;">
        <div class="container">
            <!-- Top Section -->
            <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                <!-- Title -->
                <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                    <span class="cursivefont fs-28 font-weight-light">{{ translate('Best Selling') }}</span>
                </h3>
                <!-- Links -->
                <div class="d-flex">
